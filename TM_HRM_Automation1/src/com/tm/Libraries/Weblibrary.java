...
public class Weblibrary extends BaseClass {
	...
	public static boolean isSameAs(WebElement element,String ExpectingText) {

		boolean status = false;
		try {
			String ActualText=element.getText();
			if(ActualText.contains(ExpectingText)){
				status=true;
			}
			else
				status = false;
	...
	public static boolean selectAllElements(WebElement element, int Startvalue, int EndValue) {
